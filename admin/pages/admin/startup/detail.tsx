import { Box, DataGrid, DeleteEntityButton, DetailScope, DisplayTextField, FieldContainer, GenericCell, ImageFieldView, LinkButton, Stack } from '@contember/admin'
	...
	return (
		<>
			...
			<DetailScope entity="Startup(id=$id)">
				...
				<SlotSources.Actions>
					<LinkButton to="admin/startup/edit(id: $entity.id)">
						Edit startup
					</LinkButton>
				</SlotSources.Actions>
